...
import { ArrowRight, BarChart3, Globe, Lock, Shield, Wallet, Zap } from "lucide-react";

import { LandingThemeToggle } from "@/src/views/components/landing/landing-theme-toggle";
...
export function LandingPage() {
  return (
    <div className="min-h-screen bg-background">
      <nav className="fixed top-0 z-50 w-full glass" aria-label="Navegação principal">
        ...
        <section id="features" className="py-20 sm:py-28" aria-labelledby="features-heading">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="text-center">
              <h2 id="features-heading" className="font-display text-3xl font-bold text-foreground sm:text-4xl">
