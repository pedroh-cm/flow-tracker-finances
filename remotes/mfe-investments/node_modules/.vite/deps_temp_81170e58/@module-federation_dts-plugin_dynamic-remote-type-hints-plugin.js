...
// ../../node_modules/@module-federation/dts-plugin/dist/esm/Action-DNNg2YDh.mjs
var Message = class {
...
var UpdateMode = function(UpdateMode2) {
  UpdateMode2["POSITIVE"] = "POSITIVE";
  UpdateMode2["PASSIVE"] = "PASSIVE";
  return UpdateMode2;
}({});
var ActionKind = function(ActionKind2) {
...
// ../../node_modules/@module-federation/dts-plugin/dist/esm/utils-CkPvDGOy.mjs
...
// ../../node_modules/@module-federation/dts-plugin/dist/esm/dynamic-remote-type-hints-plugin.mjs
  ...
  return {
    ...
    registerRemote(args) {
      ...
      try {
        ...
        if (remoteIp) ws2.send(JSON.stringify(new AddDynamicRemoteAction({
          remoteIp,
          remoteInfo,
          name: origin.name,
          ip: defaultIpV4
        })));
        ws2.send(JSON.stringify(new FetchTypesAction({
          name: origin.name,
          ip: defaultIpV4,
          remoteInfo
        })));
...
export {
  dynamicRemoteTypeHintsPlugin as default
};
//# sourceMappingURL=@module-federation_dts-plugin_dynamic-remote-type-hints-plugin.js.map
